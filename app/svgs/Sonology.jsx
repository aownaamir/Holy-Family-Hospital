...
const Sonology = ({ color, size }) => {
  return (
    ...
    >
      <path
        id="XMLID_1_"
        d="M215,94.5l-70.9-70.9c-9.1,9.1-23.8,9.1-32.9,0L40.3,94.5C88.6,142.8,166.8,142.8,215,94.5z M145.6,52.1
